    ...
    return (
        <>
            ...
            >
                ...
                <Modal.Footer>
                    <button className='btn btn-gradient-border' onClick={onReject}>{'No'}</button>
                    <button className='btn btn-gradient-border' onClick={onAccept}>{'Yes'}</button>
                </Modal.Footer>
            </Modal>
        </>
    )
