...
export async function fetchTeamList(data) {
  return axiosInstance
    .get("/user/v1/all/manager/users", data)
    .then((res) => res.data);
}
...
export async function assignUserToProjectByIds(data) {
  return axiosInstance
    .patch("projects/v1/assign/projects", data)
    .then((res) => res.data);
}
...
export async function getCategoriesProjectById(data) {
  return axiosInstance
...
export async function assignManagerTOUserByIds(data) {
  return axiosInstance
    .patch("user/v1/assign/manager", data)
    .then((res) => res?.data);
}
...
export async function getUsersByProject() {
  return axiosInstance
    .get("task/v1/get/today/taskCreatedUsers")
    .then((res) => res?.data);
}

export async function getFreeUsers() {
  return axiosInstance
    .get("task/v1/get/today/freeUsers")
    .then((res) => res?.data);
}
